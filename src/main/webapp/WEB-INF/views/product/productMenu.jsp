					...
					<dd style="display: none;">
						<div class="product_food_select">
							<form method="post">
								<fieldset>
									<!-- 푸드 카테고리 별 분류 보기 -->
									<div id="food_menu_container" class="product_menu">
										<ul class="food_menu">
											...
											<li style="width: 180px;"><input type="checkbox" name="product_sandwich" id="product_sandwich"> <label for="product_sandwich">샌드위치 &amp; 샐러드</label></li>
